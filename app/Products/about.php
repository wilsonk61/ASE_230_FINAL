...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Your trusted e-commerce platform" />
    ...
    <body id="page-top">
        ...
        <header class="bg-primary bg-gradient text-white">
            <div class="container px-4 text-center">
                <h1 class="fw-bolder">Welcome to YourShop</h1>
                <p class="lead">Your one-stop shop for all your needs, from fashion to electronics</p>
        ...
        <footer class="py-5 bg-dark">
            <div class="container px-4"><p class="m-0 text-center text-white">Copyright &copy; YourShop 2023</p></div>
        </footer>
        <!-- Bootstrap core JS-->
